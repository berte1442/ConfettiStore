...
namespace ConfettiStore.Controllers
{
    public class EventTypesController : Controller
    {
        ...
        public EventTypesController(StoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EventTypeId,EventName")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventTypeId,EventName")] EventType eventType)
        {
        ...
        {
            return Json(_context.EventTypes);
        }
    }
}
